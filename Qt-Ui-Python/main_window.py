...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.quit_frame = QtWidgets.QFrame(self.main_menu)
        ...
        spacerItem = QtWidgets.QSpacerItem(294, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.quit_push_button = QtWidgets.QPushButton(self.quit_frame)
        self.quit_push_button.setMinimumSize(QtCore.QSize(500, 120))
        self.quit_push_button.setObjectName("quit_push_button")
        self.horizontalLayout_2.addWidget(self.quit_push_button)
        spacerItem1 = QtWidgets.QSpacerItem(294, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem1)
        self.verticalLayout_2.addWidget(self.quit_frame)
